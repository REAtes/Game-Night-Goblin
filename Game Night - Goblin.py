...
print("count_availability: " + str(count_availability))
...
print("best night: " + str(game_night))
...
def available_on_night(gamers_list, day):
    ...
    for gamer in gamers_list:
        if day in gamer["availability"]:
            valid_gamer.append(gamer["name"])
    return  valid_gamer

attending_game_night = available_on_night(gamers, game_night)
print("best night'a gelenler: " + str(attending_game_night))
...
print("best night'a gelemeyenler: " + str(unable_to_attend_best_night))
...
print("gelemeyenlerin ortak günleri: " + str(second_night_availability))

second_night = find_best_night(second_night_availability)
print("en iyi 2. gün: " + str(second_night))
